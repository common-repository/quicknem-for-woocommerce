 ...
 * Description: This plugin enables NEM payment for WooCommerce, using Quicknem webservice. Quicknem is available in Japan and you need to register Quicknem. Quicknem costs 1% of the transaction.
        ...
        public function init_form_fields() {
            ...
            $this->form_fields = apply_filters( 'quicknem_wc_form_fields', array(
                ...
                'description' => array(
                    ...
                    'default'     => __( 'Cryptocurrency NEM Payment using Quicknem.', 'quicknem-for-woocommerce' ),
                    'desc_tip'    => true,
                ),
